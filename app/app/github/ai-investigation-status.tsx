...
export function AiInvestigationStatus({ investigationId, initialAiInvestigation, startRequestId, initialAiCandidateGeneration, candidateGenerationRequestId }: { investigationId: string; initialAiInvestigation: AiInvestigationSummary | null; startRequestId: string; initialAiCandidateGeneration: AiCandidateGenerationSummary | null; candidateGenerationRequestId: string }) {
