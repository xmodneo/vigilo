CREATE TABLE "ai_investigation" (
	...
	CONSTRAINT "ai_investigation_usage_check" CHECK ("input_tokens" between 0 and 1000000 and "output_tokens" between 0 and 100000 and "tool_call_count" between 0 and 6 and "model_turn_count" between 0 and 8),
