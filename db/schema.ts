...
export const aiCandidateGeneration = pgTable(
  ...
  (table) => [
    ...
    check('ai_candidate_generation_provider_check', sql`char_length(${table.providerId}) between 1 and 40 and char_length(${table.modelId}) between 1 and 80 and ${table.protocolVersion} in (1,2,3)`),
